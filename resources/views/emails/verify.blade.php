...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 16px;">Terima kasih telah mendaftar di <b>SahabatBK.com</b>.<br>
            Silakan klik tombol di bawah ini untuk memverifikasi email Anda:</p>
            <div style="text-align:center;">
                <a href="{{ $url }}" class="btn" target="_blank">Verifikasi Email</a>
            </div>
            <p style="font-size: 16px; margin-top: 20px;">Jika Anda tidak membuat akun, abaikan email ini.</p>
        </div>
        <div class="footer">
